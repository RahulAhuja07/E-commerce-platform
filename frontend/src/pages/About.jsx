    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4'>
            <p>Most people follow a tutorial to build a site; I built a platform to solve the "where did I put that receipt?" problem—then I turned it into this. Founded by Rahul ahuja, this project began at the intersection of a  logic and a designer’s eye for aesthetics.</p>
